        ...
        <html lang="es">
            ...
            <body>
                ...
                <main>
                    ...
                    <!-- Se define la a los 5 mejores participantes con mas de 20 puntos -->
                    <h2>5 - Mejores participantes con más de 20 puntos</h2>

                    <!-- tabla con los participantes que tienen 20 o más puntos  -->
                    <table class="participantes-t ancho">
                        ...
                        <tbody>
                            <!-- Se participantes con 20 o más puntos y crea una fila en la tabla para los 5 mejores -->
